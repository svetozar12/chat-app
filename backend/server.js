...
app.get("/user-create", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                user = new User({ username: "Example" });
                return [4 /*yield*/, user.save().then(function () { return console.log("user connected"); })];
            case 1:
                _a.sent();
