...
export async function getServerPageGetChat
    (options: Omit<Apollo.QueryOptions<Types.GetChatQueryVariables>, 'query'>, ctx: ApolloClientContext ){
...
export async function getServerPageGetChatList
    (options: Omit<Apollo.QueryOptions<Types.GetChatListQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
...
export async function getServerPageGetInvitesByInviter
    (options: Omit<Apollo.QueryOptions<Types.GetInvitesByInviterQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
...
export async function getServerPageGetInvitesByReciever
    (options: Omit<Apollo.QueryOptions<Types.GetInvitesByRecieverQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
...
export async function getServerPageGetMessageList
    (options: Omit<Apollo.QueryOptions<Types.GetMessageListQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
...
export async function getServerPageGetUserById
    (options: Omit<Apollo.QueryOptions<Types.GetUserByIdQueryVariables>, 'query'>, ctx: ApolloClientContext ){
        const apolloClient = getApolloClient(ctx);
